...
const displayLevelWord=(words)=>{
    ...
    if(words.length == 0){
        wordContainer.innerHTML=`
        <div class="text-center col-span-full rounded-xl py-4 space-y-3 font-bangla">
        <img src="./assets/alert-error.png" class="mx-auto w-[50px] h-[50px]"  alt="">
